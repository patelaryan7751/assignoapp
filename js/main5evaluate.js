...
console.log("fum");
     ...
     nhjcordiref.orderByChild("fcmtokenstudent").on("child_added", function(data){
       ...
       $.ajax({
             ...
             data:JSON.stringify({
                'to':data.val().fcmtokenstudent,'data':{'message':`Assignment Evaluated`,'icon':'https://patelaryan7751.github.io/DSC-WOW_CAPITAL-E/images/assigno.png','image':'https://patelaryan7751.github.io/DSC-WOW_CAPITAL-E/images/assigno.png','click_action':`https://patelaryan7751.github.io/DSC-WOW_CAPITAL-E/teachass.html?uid=${sessionStorage.getItem("uids")}&roomname=${sessionStorage.getItem("roomi")}`}
             }),
