...
console.log("fum");
     ...
     nhjcordiref.orderByChild("fcmtokenstudent").on("child_added", function(data){
       ...
       $.ajax({
             ...
             data:JSON.stringify({
                'to':data.val().fcmtokenstudent,'data':{'message':`Assignment Evaluated`,'icon':'https://assigno-b8431.web.app/images/assigno.png','image':'https://assigno-b8431.web.app/images/assigno.png','click_action':`https://assigno-b8431.web.app/teachass.html?uid=${sessionStorage.getItem("uids")}&roomname=${sessionStorage.getItem("roomi")}`}
             }),
